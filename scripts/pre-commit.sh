...
production_checks(){
    ...
    # Should pass pep8
    PEP=$(pep8 --ignore=E501,E221,E202,E251,W391,W291,E701,W293 --repeat app scripts | wc -l);
    if [ $PEP -gt 0 ];
    then
	pep8 --ignore=E501,E221,E202,E251,W391,W291,E701,W293 --repeat app scripts
    ...
    files=$(find app scripts -name "*.py" -not -name "__init__.py")
    if pyflakes $files;
    then
	echo "$(tput sgr0)"
